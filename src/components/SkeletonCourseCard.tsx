  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col px-4 pb-4 pt-3.5 md:px-5">
        ...
        <div className="mb-3 h-5 w-11/12 rounded-lg bg-slate-100 animate-pulse" />
        <div className="mb-4 h-5 w-4/5 rounded-lg bg-slate-100 animate-pulse" />

        <div className="mb-5 space-y-2.5">
          <div className="h-3.5 w-full rounded-lg bg-slate-100 animate-pulse" />
          <div className="h-3.5 w-5/6 rounded-lg bg-slate-100 animate-pulse" />
        </div>
